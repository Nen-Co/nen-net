...
pub const DODNetworkLayout = struct {
    ...
    pub inline fn add_connection(self: *Self, socket_fd: i32, protocol: dod_config.ProtocolType, local_port: u16, remote_port: u16) !u32 {
    ...
    pub inline fn add_request(self: *Self, connection_id: u32, method: dod_config.HttpMethod) !u32 {
