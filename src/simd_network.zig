...
pub const SIMDNetworkProcessor = struct {
    ...
    pub inline fn process_connection_batch(
        self: *Self,
    ...
    pub inline fn process_request_batch(
        self: *Self,
        layout: *dod_layout.DODNetworkLayout,
        start_index: u32,
        count: u32
    ...
    pub inline fn process_response_batch(
        self: *Self,
        layout: *dod_layout.DODNetworkLayout,
        start_index: u32,
        count: u32
    ...
    pub inline fn process_header_batch(
        _: *Self,
        layout: *dod_layout.DODNetworkLayout,
        start_index: u32,
        count: u32
    ...
    inline fn process_connection_simd_operations(
        self: *Self,
        layout: *dod_layout.DODNetworkLayout,
        count: u32
    ) void {
    ...
    inline fn process_request_simd_operations(
        self: *Self,
        _: *dod_layout.DODNetworkLayout,
        count: u32
    ) void {
    ...
    inline fn process_response_simd_operations(
        self: *Self,
        _: *dod_layout.DODNetworkLayout,
        count: u32
    ) void {
    ...
    pub inline fn parse_request(
        ...
        if (std.mem.indexOf(u8, request_data, " ")) |space_pos| {
            ...
            if (std.mem.indexOf(u8, request_data[method_end + 1..], " ")) |url_end| {
                ...
                @memcpy(self.layout.network_buffer_pool[url_offset..url_offset + url_len], 
                       request_data[url_start..url_start + url_len]);
...
pub inline fn process_mixed_network_batches(
    layout: *dod_layout.DODNetworkLayout,
